...
$(".find-em-btn").on("click", function () {
  ...
  bitEventsURL = "https://rest.bandsintown.com/artists/"
    + artist
    + "/events?app_id="
    + apiKey + "&date="
    + beginDate + "%2C"
  ...
  bitArtistInfoURL = "https://rest.bandsintown.com/artists/"
    + artist
    + "?app_id="
    + apiKey;
  ...
  if ((artist === "") || (beginDate === "") || (endDate === "")) {
    ...
    $.ajax({
      ...
      .then(function (response) {
        ...
        var artistImage = $('<img class = "artist-image" src="'
          + artistImageUrl
          + '" alt = "artist picture">');
          ...
          $.ajax({
            ...
            for (i = 0; i < response.length; i++) {
              ...
              if (response[i].offers.length === 1) {
                tickets = "available"
                var ticketsText = $('<h6 class="dynamic-text text-center col-3"">').text("Tickets: " + tickets).css("color", "rgb(48, 193, 46)");
              
              }
              else {
                tickets = "unavailable"
                var ticketsText = $('<h6 class="dynamic-text text-center col-3"">').text("Tickets: " + tickets).css("color", "rgb(234, 32, 32)");
              ...
              var cardHeader = $(`<div class="card-header resultTitle row" id= "heading${i}">`);
              ...
              var timeText = $('<h6 class="dynamic-text text-center col-3 col-md-2"">').text(time);
              var ticketsText = $('<h6 class="dynamic-text text-center col-3"">').text("Tickets: " + tickets);
              var cardHeaderButton = $('<button id="expand-btn" class="openBtn btn btn-link expand-button collapsed col-1" type="button" data-lat= "' +
                ...
                + i + '" aria-expanded="false"aria-controls="collapseOne">')
                .html('<i class="fa fa-info-circle" aria-hidden="true"></i>');
              var contentDivRow = $('<div class="row content-div">');
              var tmCol = $('<div class="tm-col col-2">');
              var venueDetailCol = $('<div class="venue-details col-2">')
                .html("<h5> Venue Info </h5> <br>" + venueName + "<br> <br>"
                  + "<span id='address"
                  + i + "'>");
